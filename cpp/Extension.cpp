...
namespace WT {
    ...
    typedef void(WT_STDCALL* FP_glDeleteBuffers)(GLsizei n, const GLuint* buffers);
    typedef GLuint(WT_STDCALL* FP_glCreateShader)(GLenum type);
    typedef void(WT_STDCALL* FP_glBindBuffer)(GLenum target, GLuint buffer);
    typedef void(WT_STDCALL* FP_glGenBuffers)(GLsizei n, GLuint* buffers);
    typedef void(WT_STDCALL* FP_glBufferData)(GLenum target, GLsizeiptr size, const GLvoid* data, GLenum usage);

    typedef void(WT_STDCALL* FP_glBlendEquationSeparate)(GLenum modeRGB, GLenum modeAlpha);
    typedef void(WT_STDCALL* FP_glBlendFuncSeparate)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);

    typedef void(WT_STDCALL* FP_glBlendEquation)(GLenum mode);

    typedef void(WT_STDCALL* FP_glActiveTexture)(GLenum texture);

    typedef void(WT_STDCALL* FP_glUniform1i)(GLint location, GLint v0);
    typedef void(WT_STDCALL* FP_glUniform3f)(	GLint location,
                                                GLfloat v0,
                                                GLfloat v1,
                                                GLfloat v2);
    typedef void(WT_STDCALL* FP_glUniform1f)(	GLint location,
                                                GLfloat v0);

    typedef void(WT_STDCALL* FP_glShaderSource)(GLuint shader, GLsizei count, const GLchar** strings, const GLint* lengths);

    typedef void(WT_STDCALL* FP_glCompileShader)(GLuint shader);

    typedef void(WT_STDCALL* FP_glGetShaderiv)(GLuint shader, GLenum pname, GLint* param);

    typedef GLuint(WT_STDCALL* FP_glCreateProgram)(void);

    typedef void(WT_STDCALL* FP_glAttachShader)(GLuint program, GLuint shader);

    typedef void(WT_STDCALL* FP_glDeleteProgram)(GLuint program);
    typedef void(WT_STDCALL* FP_glDeleteShader)(GLuint shader);
    typedef void(WT_STDCALL* FP_glLinkProgram)(GLuint program);

    typedef void(WT_STDCALL* FP_glGetProgramiv)(GLuint program, GLenum pname, GLint* param);

    typedef void(WT_STDCALL* FP_glGetShaderInfoLog)(GLuint shader, GLsizei bufSize, GLsizei* length, GLchar* infoLog);
    typedef void(WT_STDCALL* FP_glGetProgramInfoLog)(GLuint program, GLsizei bufSize, GLsizei* length, GLchar* infoLog);

    typedef GLint(WT_STDCALL* FP_glGetAttribLocation)(GLuint program, const GLchar* name);

    typedef GLint(WT_STDCALL* FP_glGetUniformLocation)(GLuint program, const GLchar* name);

    typedef void(WT_STDCALL* FP_glUseProgram)(GLuint program);

    typedef void(WT_STDCALL* FP_glEnableVertexAttribArray)(GLuint index);
    typedef void(WT_STDCALL* FP_glDisableVertexAttribArray)(GLuint index);
    typedef void(WT_STDCALL* FP_glVertexAttribPointer)(
        GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* pointer);
    typedef void(WT_STDCALL* FP_glUniformMatrix4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
    typedef void(WT_STDCALL* FP_glUniform4fv)(GLint location, GLsizei count, const GLfloat* value);
    typedef void(WT_STDCALL* FP_glGenerateMipmap)(GLenum target);
    typedef void(WT_STDCALL* FP_glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid* data);

    typedef void(WT_STDCALL* FP_glGenVertexArrays)(GLsizei n, GLuint* arrays);
    typedef void(WT_STDCALL* FP_glDeleteVertexArrays)(GLsizei n, const GLuint* arrays);
    typedef void(WT_STDCALL* FP_glBindVertexArray)(GLuint array);

    typedef void(WT_STDCALL* FP_glGenSamplers)(GLsizei n, GLuint* samplers);
    typedef void(WT_STDCALL* FP_glDeleteSamplers)(GLsizei n, const GLuint* samplers);
    typedef void(WT_STDCALL* FP_glSamplerParameteri)(GLuint sampler, GLenum pname, GLint param);
    typedef void(WT_STDCALL* FP_glBindSampler)(GLuint unit, GLuint sampler);

    typedef void*(WT_STDCALL* FP_glMapBuffer)(GLenum target, GLenum access);
    typedef void*(WT_STDCALL* FP_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
    typedef GLboolean(WT_STDCALL* FP_glUnmapBuffer)(GLenum target);

    typedef void(WT_STDCALL* FP_glDrawElementsInstanced)(GLenum mode,
                                                          GLsizei count,
                                                          GLenum type,
                                                          const void* indices,
                                                          GLsizei primcount);

    typedef void(WT_STDCALL* FP_glCompressedTexImage2D)(
    ...
    typedef void(WT_STDCALL* FP_glGenFramebuffers)(GLsizei n, GLuint* ids);

    typedef void(WT_STDCALL* FP_glBindFramebuffer)(GLenum target, GLuint framebuffer);

    typedef void(WT_STDCALL* FP_glDeleteFramebuffers)(GLsizei n, GLuint* framebuffers);

    typedef void(WT_STDCALL* FP_glFramebufferTexture2D)(GLenum target,
                                                         GLenum attachment,
                                                         GLenum textarget,
                                                         GLuint texture,
                                                         GLint level);

    typedef void(WT_STDCALL* FP_glDrawBuffers)(GLsizei n, const GLenum* bufs);
    typedef void(WT_STDCALL* FP_glDrawArrays)(GLenum mode, GLint first, GLsizei count);
    ...
    static FP_glUniform1f g_glUniform1f = nullptr;
    static FP_glUniform3f g_glUniform3f = nullptr;
    ...
    static FP_glDrawArrays g_glDrawArrays = nullptr;


#elif defined(__RENDERER_GLES2__)
...
#ifdef EMSCRIPTEN
    typedef void(WT_STDCALL* FP_glDrawElementsInstancedANGLE)(GLenum mode,
                                                               GLsizei count,
                                                               GLenum type,
                                                               const void* indices,
                                                               GLsizei primcount);
...
#define GET_PROC_REQ(name)                                                                           \
    ...
    if (g_##name == nullptr)                                                                     \
    {                                                                                            \
        std::cout  << "Failed to get proc : "  << std::string(#name) << std::endl; \
        return false;                                                                            \
    }
#elif defined(__RENDERER_GLES2__) || defined(__RENDERER_GLES3__)
#define GET_PROC_REQ(name)                                                                           \
...
#define GET_PROC(name)                              \
    ...
    bool Initialize(OpenGLDeviceType deviceType, bool isExtensionsEnabled) {
        ...
        GET_PROC_REQ(glUniform1f);
        GET_PROC_REQ(glUniform3f);
...
#elif defined(__RENDERER_GLES2__) || defined(__RENDERER_GL2__)
#else
